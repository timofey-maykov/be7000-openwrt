...
Текущая версия 1.2. Образы лежат в Releases, проверяйте суммы по sha256sums.txt. Что изменилось после 1.1, описано ниже в разделе про версии.
...
Она отказывается работать с примонтированным диском и с внутренней флешью, форматирует только после --yes, переносит текущий оверлей и прописывает fstab по UUID. В LuCI то же самое на странице Накопитель.
