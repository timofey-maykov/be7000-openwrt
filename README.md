...
**1.3**, в работе. Проверка и установка обновлений из GitHub Releases, команда be7000-update и страница Система, Обновление сборки. Docker: пакеты, модули и страницы уже в 1.2.4, осталось проверить вживую.
